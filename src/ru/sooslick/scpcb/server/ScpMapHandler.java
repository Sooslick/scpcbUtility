...
public class ScpMapHandler implements HttpHandler {
    ...
    public void handle(HttpExchange httpExchange) {
        ...
        if (saveEnable) {
            String filename = makeSavePath(seedNumber);
    ...
    private String makeSavePath(int seedNumber) {
        int mils = seedNumber / 1000_000 + 1;
        int thous = (seedNumber % 1000_000) / 1000 + 1;
        String dir = outputDir + File.separator + mils + File.separator + thous + File.separator;
        new File(dir).mkdirs();
        return dir + seedNumber + ".json";
    }
}
